...
if __name__ == "__main__":
    ...
    configs = [

        {
            ...
            "csv": "circExor/reference_preprocessing/heldout_circRNA_3.20/exoRbase_output.bak.csv",
...

        {
            ...
            "csv": "circExor/reference_preprocessing/heldout_circRNA_3.20/filtered_celline_arrary_df.csv",
