...
if __name__ == "__main__":
    ...
    # 文件1：exoRbase 
    exo_csv = "/lulabdata3/huangkeyun/zhangys/RNA_locator/ML_python_scripts/reference_preprocessing/heldout_circRNA_3.20/exoRbase_output.bak.csv"
    csv_to_fasta(exo_csv, f"{out_dir}/target_exoRbase.fasta", id_col='circID', seq_col='Sequence')
    
    # 文件2：celline 
    cell_csv = "/lulabdata3/huangkeyun/zhangys/RNA_locator/ML_python_scripts/reference_preprocessing/heldout_circRNA_3.20/filtered_celline_arrary_df.csv"
