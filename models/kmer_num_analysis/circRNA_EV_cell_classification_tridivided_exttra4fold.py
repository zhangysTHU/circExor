...
def logistic_regression_classification(x_train, y_train, x_test, y_test, output_dir, fold_id="", SEED=42):
    ...
    fold_id : Identifies the current fold to avoid overwriting results
...
def SVM_classification(x_train, y_train, x_test, y_test, output_dir, fold_id="", SEED=42):
    ...
    """
    Run binary SVM classification with hyperparameter tuning, training, evaluation, and result saving.
    """
...
def RF_classification(x_train, y_train, x_test, y_test, output_dir, fold_id="", SEED=42, n_iter=100):
    ...
    """
    Run binary Random Forest classification with hyperparameter tuning, training, evaluation, and result saving.
    """
...
output_dir = "circExor/kmer_num_analysis/kmer67_extra4fold_output"
